package org.olmedo.webapp.jaxws.controllers;
...
import org.olmedo.webapp.jaxws.services.CursoService;
...
@RequestScoped
@Path("/cursos")
@Produces(MediaType.APPLICATION_JSON) // siempre va producir un contenido XML o a JSON
public class CursoRestController {
    ...
    @GET
    @Path("/{id}")
    public Response porId(@PathParam("id") Long id) { // el nombre del @PathParam tene que ser del mismo del @Path
    ...
    @POST
    @Consumes(MediaType.APPLICATION_JSON) // pasamos el tipo de formnato que nos envian en request como parametro
